...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 w-full bg-white/95 backdrop-blur-lg z-50 border-b border-gray-200 dark:bg-black/95 dark:border-gray-800 shadow-sm" suppressHydrationWarning>
